...
import edu.bu.metcs.projectportal.screens.projaddedit.ProjAddEdit
import edu.bu.metcs.projectportal.screens.projects.GithubProjsScreen
import edu.bu.metcs.projectportal.screens.projects.ProjsScreen
    ...
    NavHost(navController = navController, startDestination = PROJECTS_ROUTE) {
        composable(route = PROJECTS_ROUTE) {
            ProjsScreen(
                ...
                onGithubProj = {
                    navController.navigate("GithubProjects")
                },
                onSignOut = onSignOut
            )
        }
        composable (route = "GithubProjects"){
            GithubProjsScreen()
        }
        composable(
